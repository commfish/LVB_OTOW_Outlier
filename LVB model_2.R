...
fitTypicalM <- nls(length~vbTypical(age,Linf,K,t0),data=dataYRF,subset=sex== c("M"), start=svTypical)
fitTypicalF <- nls(length~vbTypical(age,Linf,K,t0),data=dataYRF,subset=sex==c("F" ), start=svTypical)
